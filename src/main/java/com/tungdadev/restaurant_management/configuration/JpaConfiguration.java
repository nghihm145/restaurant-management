...
/**
 * @author TungDaDev
 * @since 09/12/2024 - 10:06
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.tungdadev.restaurant_management.repository", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
...
public class JpaConfiguration {
    ...
    /*
     * Populate SpringBoot DataSourceProperties object directly from application.yml.yml
